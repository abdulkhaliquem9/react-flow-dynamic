...
export default function CustomNode(props) {
  const { id, data, ...rest } = props
    ...
    if(!imgSrc){
      return (
        <div style={{backgroundColor:'white', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', border: '1px solid black', borderRadius: '3px', width: '50px', minWidth: '50px', height: '50px', textAlign:'center'}}>
          {
